...
- **logo do cabeçalho simplificado**: substituída a imagem raster de baixa resolução (com subtítulo redundante) por uma marca vetorial minimalista — o mesmo símbolo de onda sonora oficial (17 barras) ao lado do nome "fonUFAL" em texto real, nas cores oficiais;
